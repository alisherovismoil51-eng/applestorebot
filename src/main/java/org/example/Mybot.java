...
public class Mybot extends TelegramLongPollingBot {
        ...
        private static final String[][] PRODUCTS = {
                ...
                // ── 🆕 iPhone 17 Pro Max ─────────────────────────────────
                {
                        ...
                        "iPhone 17 Pro Max",
                        "1 630$",
                        "https://cdn.mediapark.uz/imgs/19525c8c-3a49-46a1-a7af-f032087f8a7c_5.webp",
                        "⚡️ *Chip:* A19 Pro (6-yadro GPU) — yangi avlod!\n"
                                + "🖥 *Ekran:* 6.9\" Super Retina XDR ProMotion 120Hz Always-On\n"
                                + "🌈 *Ranglar:* Desert Titanium, Black, White, Natural\n"
                                + "💾 *Xotira:* 256GB / 512GB / 1TB\n"
                                + "🧠 *RAM:* 12GB\n"
                                + "📸 *Kamera:* 48MP Fusion + 48MP ultra wide + 12MP 5x telephoto\n"
                                + "🤳 *Front:* 24MP TrueDepth — 4K video selfie\n"
                                + "🎥 *Video:* 4K 120fps ProRes, Apple Log, Dolby Vision\n"
                                + "🔋 *Batareya:* 4685 mAh — 33 soat video\n"
                                + "🔌 *Port:* USB-C (USB 3 — 40Gb/s Thunderbolt)\n"
                                + "🛡 *Korpus:* Grade 5 Titanium + Ceramic Shield Ultra, IP68\n"
                                + "🤖 *Apple Intelligence* — kuchli AI tizim\n"
                                + "📡 *Aloqa:* 5G + Wi-Fi 7 + Bluetooth 5.4 + UWB\n"
                                + "⚖️ *Og'irlik:* 227 g | *Qalinlik:* 8.2 mm"
                },
